...
/*
 * Function that calculates the distance from digital voltage readings 
 * from Sensors
 * Note: This method may vary from the sensor you are using. 
 * Refer to the SENSOR DATASET for accuarte measurement. 
*/
